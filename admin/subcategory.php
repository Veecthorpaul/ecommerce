...
$sql=mysqli_query($con,"insert into subcategory(categoryid,subcategoryName) values('$category','$subcat')");
...
<?php $query=mysqli_query($con,"select subcategory.id,category.categoryName,subcategory.subcategoryName,subcategory.creationDate,subcategory.updationDate from subcategory join category on category.id=subcategory.categoryid");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>									
