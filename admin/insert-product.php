...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,productPrice,productQuantity,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$category','$subcat','$productname','$productcompany','$productprice','$productquantity','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<div class="controls">
<select name="subcategory" id="subcategory" class="span8 tip" onChange="getBrand(this.value);"  required>
<option value="">Select Subcategory</option> 
<?php $query=mysqli_query($con,"select * from subcategory where categoryid=$id");
while($row=mysqli_fetch_array($query))
{?>
...
<div class="controls">
<select name="productCompany" id="brands" class="span8 tip"  required>
<option value="">Select Brands</option> 
<?php $query=mysqli_query($con,"select * from brands where subcategoryId=$id");
while($row=mysqli_fetch_array($query))
{?>

<option value="<?php echo $row['productCompany'];?>"></option>
<?php } ?>
</select>
</div>
</div>
