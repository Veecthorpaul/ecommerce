...
<?php 
$ret=mysqli_query($con,"select products.*,brand.productCompanyName from products join brand on brand.id=products.productCompany where products.id='$pid'");
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									...
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value"><?php echo htmlentities($row['productCompanyName']);?></span>
										</div>	
									</div>
								</div><!-- /.row -->	
							</div>
